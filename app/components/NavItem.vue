<template>
  ...
  >
    <span
      class="w-fit text-sm text-lightpurple dark:text-lightgray motion-safe:transition-transform motion-safe:duration-500 motion-safe:group-hover:translate-y-full"
    >
      {{ props.label }}
    </span>
    <span
