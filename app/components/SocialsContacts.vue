<template>
  <section
    aria-label="socials"
    class="flex items-center justify-between mt-6 py-6 border-t dark:border-mediumpurple"
  >
    <div class="flex items-center gap-2">
      <NuxtLink
        ...
        title="Linkedin"
        tabindex="0"
        to="https://www.linkedin.com/in/xavhm/"
        target="_blank"
      >
        <svg
          ...
          viewBox="0 0 256 256"
          class="fill-lightpurple dark:fill-lightgray"
        ><path
